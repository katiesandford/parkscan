...
public class CameraPreviewActivityFragment extends Fragment
    ...
    private @Nullable
    OnBarcodeScannedListener mListener;
    ...
    private ThreadPoolExecutor executor = new ThreadPoolExecutor(AVAILABLE_PROCESSORS, AVAILABLE_PROCESSORS, 500L, TimeUnit.MILLISECONDS, new SynchronousQueue<Runnable>(), new ThreadPoolExecutor.AbortPolicy());
...
//            reader.acquireLatestImage().close();
    ...
    public static CameraPreviewActivityFragment newInstance() {
        return new CameraPreviewActivityFragment();
    }
...
//        view.findViewById(R.id.fragment).setOnClickListener(this);
//        view.findViewById(R.id.info).setOnClickListener(this);
        mTextureView = (AutoFitTextureView) view.findViewById(R.id.camera);
        mTextureView.setAspectRatio(18, 10);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnBarcodeScannedListener) {
            mListener = (OnBarcodeScannedListener) context;
        } else {
...
//                        mOnImageAvailableListener, mBackgroundHandler);
                ...
                mImageReader = ImageReader.newInstance(mPreviewSize.getWidth(), mPreviewSize.getHeight(),
                        ImageFormat.YUV_420_888, /*maxImages*/AVAILABLE_PROCESSORS*2);
                mImageReader.setOnImageAvailableListener(
                        mOnImageAvailableListener, mBackgroundHandler);
...
//                }
    ...
    /**
     * Opens the camera specified by {@link CameraPreviewActivityFragment#mCameraId}.
     */
...
//        matrix.postScale(scale, scale, centerX, centerY);
    ...
    public interface OnBarcodeScannedListener {
        ...
        void onRunnerScanned(String runnerID);
        void onPositionScanned(String position);
    }
}
...
// */
//public class CameraPreviewActivityFragment extends Fragment implements TextureView.SurfaceTextureListener // implements DecodeManager.CompletedDecodeTaskListener<BarCodeTaskWorker>
//{
//
...
//        TextureView cameraView = (TextureView) fragmentView.findViewById(R.id.camera);
...
//                if (lensFacing != null) {
//                    if (lensFacing.equals(CameraCharacteristics.LENS_FACING_BACK)) {
...
//                        } else {
//                            cameraManager.openCamera(cameraID, new CameraPreviewActivityFragmentCameraCallback(), null);
//                        }
//                    }
//                }
//            }
...
//
//    private class CameraPreviewActivityFragmentCameraCallback extends CameraDevice.StateCallback {
//        @Override
...
//                if (configs != null) {
//
//                    Size[] outputSizes = configs.getOutputSizes(ImageFormat.YUV_420_888);
//                    for (Size size : outputSizes) {
//
//                    }
//
//                    ImageReader reader = ImageReader.newInstance(1, 1, ImageFormat.YUV_420_888, 2);
//                    List<Surface> cameraOutputSurfaces = new ArrayList<>(2);
//                    cameraOutputSurfaces.add(reader.getSurface());
//                    camera.createCaptureSession(cameraOutputSurfaces, new CameraCaptureSession.StateCallback() {
//                        @Override
...
//                    captureSession.set();
//
//                    captureSession.addTarget(reader.getSurface());
//                }
//            } catch (CameraAccessException e) {
//                e.printStackTrace();
//            }
